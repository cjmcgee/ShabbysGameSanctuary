...
public class C64Palette : Palette
{
	...
	public C64Palette() : base(
		[
			Black, Brown, DarkBrown, Red, DarkRed, Yellow,
			White, Grey, Blue, DoorBlack, LightGrey, Cyan,
			Green, NearBlack, DarkGrey, MidBlue, DarkGray, DarkOlive,
			MidBrown, DeepRed, SkinMedium, SkinMedium2, LightGreen, BurntOrange,
			SkinTan, SkinTan2, MidMagenta, SkinTan3, SkinLight, SkinPale,
			BrightYellow, Salmon,
		])
	{
	}
