...
public sealed class C64System : RetroSystem
{
    ...
    // Bold red carpet — corner dots + centre fill
    ...
    // Yellow kitchen tile — horizontal grout rows
    ...
    // Staggered brick wall — horizontal mortar at rows 2 & 5
    ...
    // Blue-frame door — recessed panel; knob hint at lp2 row 6
    ...
    // Cyan window — two top panes (sash at lp2), wide lower pane
    ...
    // Blue furniture — white inner border, black interior
    ...
    // Light-grey counter — white border inset, grey detail stripe
    ...
    // Green grass — dark texture spots at lp1 and lp2 alternating rows
    ...
    // Near-black road — white centre line
    ...
    // Dark-grey sidewalk — crack joints at lp0 and lp2
    ...
    // Accent — solid with subtle grey dot pattern at lp1 and lp3
