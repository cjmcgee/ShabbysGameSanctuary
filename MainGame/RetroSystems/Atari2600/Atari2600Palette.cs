...
public class Atari2600Palette : Palette
{
	...
	public Atari2600Palette() : base(
		[
			Black, WarmAmber, DarkBrown, VividRed, DarkRed, BrightYellow,
			NearWhite, LightGray, NearBlack, BoldBlue, MidGray, BrightCyan,
			VividGreen, DarkSlate, MediumGray, DarkGreen, DarkTeal,
		])
	{
	}
}
